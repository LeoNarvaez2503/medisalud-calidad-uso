...
\vspace{0.25cm}
\includegraphics[width=0.28\textwidth]{Logo_ESPE.png}\par
\vspace{0.35cm}
...
\begin{center}
\centering
\includegraphics[width=0.72\textwidth]{mapa_square.png}
\captionof{figure}{Familia ISO/IEC 25000 SQuaRE y relación con calidad interna, externa y en uso.}
\end{center}
